...
- You can open and close each question by clicking the caret icon
- You can see the text color states by the open and close questions
- You can See each question's description.
